...
export default function StatsAndTestimonials() {
  /* ----------- data ----------- */
  const stats = [
    { label: "Learners",    value: 120_00},
    { label: "Courses",     value: 10 },
    { label: "Instructors", value: 13 },
  ];
...
const reviews = [
  ...
  },
  {
    ...
    text:
      "I started with zero editing knowledge. Now I bill $4 k+/mo to international clients.",
      ...
      <div className="stats">
        {stats.map((s) => (
          <div key={s.label} className="stat-box">
            {/* Wrap number so we can style it */}
